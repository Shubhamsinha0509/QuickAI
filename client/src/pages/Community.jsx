          ...
          sm:max-w-1/2 lg:max-w-1/3">
            ...
            to-black/80 text-white rounded-lg">
              ...
              <div className="flex gap-1 items-center">
                ...
                <Heart onClick={()=> imageLikedToggle(creation.id)} className={`min-w-5 h-5 hover:scale-110 cursor-pointer ${creation.likes.includes(user.id) ? 'fill-red-500 text-red-600' : 
                  'text-white'}`}/>
              </div>
            </div>
          </div>
